...
pub const WHITE_PAWN_MASKS: [Bitboard; 64] = Pawn::generate_all_movement_masks(crate::player::Player::White);
pub const BLACK_PAWN_MASKS: [Bitboard; 64] = Pawn::generate_all_movement_masks(crate::player::Player::Black);
