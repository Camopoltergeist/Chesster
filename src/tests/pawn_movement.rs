...
fn white_pawn_movement_without_collision_d2() {
    ...
    let received_moves = position.generate_legal_moves_for_tile_position(TilePosition::from_tile_str("d2").unwrap());
...
fn black_pawn_movement_without_collision_d7() {
    ...
    let received_moves = position.generate_legal_moves_for_tile_position(TilePosition::from_tile_str("d7").unwrap());
...
fn white_pawn_movement_without_collision_d3() {
    ...
    let received_moves = position.generate_legal_moves_for_tile_position(TilePosition::from_tile_str("d3").unwrap());
...
fn black_pawn_movement_without_collision_d6() {
    ...
    let received_moves = position.generate_legal_moves_for_tile_position(TilePosition::from_tile_str("d6").unwrap());
